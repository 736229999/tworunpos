 ...
 *
 */
public class ComScaeDialog06TEST
{
    ...
    public static String getString10(int z1, int z2 ){
        ...
        String result = ""+EOT+STX+"10"+ESC+csRotated_String+kwRotated_String+ESC+ETX;
        return result;
    }
    ...
    public static void main ( String[] args )
    {
        try
        {
            ComScaeDialog06TEST com = new ComScaeDialog06TEST();
            com.connect("COM3");
