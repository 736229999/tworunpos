 ...
 */
	...
	public Transaction(DBObject articleDbObject){
	...
	public Transaction(String barcode, String name, ArticleUnit unit, Double priceGross, Double vatPercentage ){
		setBarcode(barcode);
		setName(name);
		setUnit(unit);
